...
### Introduction
The project is based on two papers: **Lv et al.** Constructing 3D facial hierarchical structure based on surface measurements; **Desbrun et al.** Intrinsic parameterizations of surface meshes.
